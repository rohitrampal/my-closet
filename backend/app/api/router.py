...
api_router.include_router(contact_v1.router, tags=["contact"])
api_router.include_router(analytics_v1.router, prefix="/analytics", tags=["analytics"])
...
api_router.include_router(payment_v1.router, prefix="/payment", tags=["payment"])

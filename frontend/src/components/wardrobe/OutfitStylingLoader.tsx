...
export function OutfitStylingLoader({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="outfit-styling-shimmer text-center font-semibold tracking-tight text-foreground">
      ...
      {hint ? <p className="max-w-sm text-center text-sm text-muted">{hint}</p> : null}
    </div>
  )
}

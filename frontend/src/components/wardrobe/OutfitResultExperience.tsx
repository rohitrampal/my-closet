...
export function OutfitResultExperience({
  ...
  return (
    <>
    <div className="animate-outfit-highlight space-y-6 rounded-2xl border border-violet-200/70 bg-gradient-to-b from-violet-50/90 via-white/80 to-transparent p-4 shadow-lg shadow-violet-500/10 transition-all duration-500 ease-out dark:border-violet-900/55 dark:from-violet-950/50 dark:via-zinc-950/40 dark:shadow-violet-950/20 sm:p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-1.5 sm:items-end">
          ...
          <div
            className="h-1.5 w-full max-w-[220px] overflow-hidden rounded-full bg-zinc-200/90 dark:bg-zinc-800"
            role="presentation"
            aria-hidden
          >
            <div
      ...
      <p className="text-sm text-zinc-600 dark:text-zinc-400">{t('outfit.stylistHint')}</p>

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div
          className="outfit-results-stagger"
      ...
      <Card
        className="outfit-results-stagger border-violet-200/60 bg-white/90 p-4 transition-all duration-300 dark:border-violet-900/45 dark:bg-zinc-900/80 sm:p-5"
      ...
      >
        ...
        >
          {rationaleLines.map((line, index) => (
            ...
            >
              <span className="inline-flex max-w-full items-start gap-2 rounded-xl border border-violet-200/70 bg-violet-50/50 px-3 py-2 text-left text-sm leading-snug text-zinc-700 dark:border-violet-800/60 dark:bg-violet-950/30 dark:text-zinc-200">
                <span
        ...
        <div className="flex flex-wrap gap-2 sm:justify-end">
          <Button
            ...
            className={`min-h-11 min-w-[8.5rem] transition-all duration-200 ease-out ${
              feedbackChoice === 'like'
                ? 'ring-2 ring-emerald-500/90 ring-offset-2 ring-offset-white dark:ring-offset-zinc-950'
          ...
          <Button
            ...
            className={`min-h-11 min-w-[8.5rem] transition-all duration-200 ease-out ${
              feedbackChoice === 'dislike'
                ? 'bg-red-50 text-red-900 ring-2 ring-red-500/90 ring-offset-2 ring-offset-white dark:bg-red-950/45 dark:text-red-100 dark:ring-offset-zinc-950'
                : 'hover:scale-[1.02] active:scale-[0.98]'
            }`}
